...
export const RISK_REGISTER_CANONICAL_PROJECT_CONTEXT_SELECT =
...
/**
 * Risk Register Project Context for gated project-scoped use: canonical
 ...
 */
export function resolveRiskRegisterProjectContext(args: {
