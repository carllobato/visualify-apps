...
/** Same Supabase password flow as RiskAI settings (`signInWithPassword` then `updateUser`). */
  ...
  return (
    <form onSubmit={(e) => void handleSubmit(e)} className="space-y-3" noValidate>
      <div className="max-w-sm">
        <Label htmlFor="hq-settings-current-password" className="!mb-1">
          Current password{" "}
        ...
        <Input
          id="hq-settings-current-password"
          type="password"
          ...
          aria-describedby={fieldErrors.current ? "hq-settings-current-password-err" : undefined}
        />
        {fieldErrors.current ? (
          <p
            id="hq-settings-current-password-err"
      ...
      <div className="max-w-sm">
        <Label htmlFor="hq-settings-new-password" className="!mb-1">
          New password{" "}
          <span className="text-[var(--ds-status-danger-fg)]" aria-hidden>
            *
          </span>
        ...
        <Input
          ...
          aria-describedby={fieldErrors.new ? "hq-settings-new-password-err" : undefined}
        />
        {fieldErrors.new ? (
          <p
            id="hq-settings-new-password-err"
            className="mt-1 text-[length:var(--ds-text-xs)] text-[var(--ds-status-danger-fg)]"
          >
            {fieldErrors.new}
          </p>
      ...
      <div className="max-w-sm">
        <Label htmlFor="hq-settings-confirm-password" className="!mb-1">
        ...
        <Input
          id="hq-settings-confirm-password"
          type="password"
          ...
          aria-describedby={fieldErrors.confirm ? "hq-settings-confirm-password-err" : undefined}
        />
        {fieldErrors.confirm ? (
          <p
            id="hq-settings-confirm-password-err"
            className="mt-1 text-[length:var(--ds-text-xs)] text-[var(--ds-status-danger-fg)]"
          >
            {fieldErrors.confirm}
          </p>
