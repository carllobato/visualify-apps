...
export function ReportProjectReportDashboardSkeleton() {
  return (
    <ReportSkeletonPage
      ...
      className="report-project-page flex min-h-0 min-w-0 flex-1 flex-col max-md:overflow-x-visible"
    >
        ...
        <div className="flex flex-col gap-y-1 max-md:min-w-0 sm:flex-row sm:flex-wrap sm:items-center sm:justify-between sm:gap-x-4 sm:gap-y-2">
          ...
          <div
            className={[
              ...
              "shrink-0 justify-end gap-2 max-md:h-auto max-md:min-h-0 max-md:w-full max-md:min-w-0",
