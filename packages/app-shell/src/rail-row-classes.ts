...
export const RAIL_ROW_SHELL_CLASS =
  "relative flex h-10 min-h-10 max-h-10 max-md:min-h-11 max-md:h-11 max-md:max-h-11 w-full min-w-0 items-center gap-0 rounded-[var(--ds-radius-md)] no-underline " +
