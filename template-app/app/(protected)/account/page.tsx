...
import { TemplateAccountSettingsClient } from "./template-account-settings-client";

export const dynamic = "force-dynamic";

/** Minimal account route — demonstrates canonical settings shell composition for new apps. */
export default async function TemplateAccountPage() {
