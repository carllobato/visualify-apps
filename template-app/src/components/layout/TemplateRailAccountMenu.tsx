...
const ACCOUNT_SETTINGS_HREF = "/account";
...
/** Account trigger + dropdown for Template App rail (HQ / RiskAI pattern). */
export function TemplateRailAccountMenu({ railPageActive = false }: { railPageActive?: boolean }) {
