...
import { ControlAiAccountSettingsClient } from "./controlai-account-settings-client";

export const dynamic = "force-dynamic";

export default async function ControlAiAccountPage() {
  ...
  return (
    <AccountSettingsPage>
      <ControlAiAccountSettingsClient
